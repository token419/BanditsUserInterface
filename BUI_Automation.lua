					...
					if obj and obj.node.data.isLocked == false then
						...
						if DungeonIndex[id] then
							...
							if BUI.Vars.UndauntedPledges then
								...
								text=IsAchievementComplete(completion) and "|t16:16:/esoui/art/cadwell/check.dds|t" or ""
							end
							--Dungeon quest icon
							if BUI.Vars.DungeonQuests and c == 2 then
							...
							--Achievment icons
							if BUI.Vars.UndauntedPledges and c == 3 then
...
--				local w=parent:GetWidth()
				if BUI.Vars.UndauntedPledges and isVeteran==c then
